...
<body>
    ...
    <!-- ***** Hero Area Start ***** -->
    <div class="fancy-hero-area bg-img bg-overlay animated-img" style="background-image: url(img/bg-img/baby.jpg);">
    ...
    <section class="footer">
        <div class="container text-center">
            <p>All rights reserved. System Designed By 6th Sem Student.</p>
        </div>
    </section>
